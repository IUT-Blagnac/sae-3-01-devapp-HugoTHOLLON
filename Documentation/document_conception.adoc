...
image::Documentation/images/UC.png[UC, 50%]
...
image::Documentation/images/DS_AjoutPanier.png[DS_AjoutPanier, 50%]
...
image::Documentation/images/DS_Commande.png[DS_Commande, 50%]
...
image::Documentation/images/DC_Métier.png[DC_Métier, 50%]
